      ...
      <div>
        <BrowserRouter>
          <Switch>
            ...
            <Route exact path="/Administrator/Authentication/Dispositivos" component={validateAuth(Dispositivos)}/>
            ...
            <Route exact path="/Administrator/Sensores/DatosNodoSensor" component={validateAuth(DatosNodoSensor)}/>
            <Redirect to ="/Home"/>
          </Switch>
        </BrowserRouter>
      </div>
