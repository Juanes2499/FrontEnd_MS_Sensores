            ...
            permisosArray.forEach(x => {
                ...
                permisosAsignadosArraySinComillas.forEach(k => {
                    if (arrayPorMicroservicio.filter(j => j.NOMBRE_MODULO === k).length !== 0){
                        ...
                        iconModulo = arrayPorMicroservicio.filter(j => j.NOMBRE_MODULO === k)[0].ICON_MODULO !== null ? arrayPorMicroservicio.filter(j => j.NOMBRE_MODULO === k)[0].ICON_MODULO : "<IoIcons.IoIosPaper />";
